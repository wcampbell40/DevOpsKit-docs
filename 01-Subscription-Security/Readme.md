...
7. <h4> Configure role settings for role on an Azure resource (-ConfigureRoleSettings) </h4>
     ...
     The command currently supports configuring of the following settings: Maximum assignment duration, maximum activation duration, requirement of justification upon activation, requirement of mfa on activation.
